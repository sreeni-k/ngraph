...
namespace ngraph
{
    namespace builder
    {
        ...
        Output<Node> l1_norm(const Output<Node>& node, const AxisSet& reduction_axes, float bias)
        {
        ...
        Output<Node> l2_norm(const Output<Node>& node, const AxisSet& reduction_axes, float bias)
        {
