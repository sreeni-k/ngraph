...
namespace ngraph
{
    namespace runtime
    {
        namespace cpu
        {
            ...
            {
                writer << "get_distributed_interface()->all_reduce(" << args[0].get_name() << ", "
                       << out[0].get_name() << ", " << args[0].get_name() << ".get_element_type(), "
                       << out[0].get_size() << ");\n";
            }
            ...
            {
                writer << "get_distributed_interface()->broadcast(" << args[0].get_name() << ", "
                       << args[0].get_name() << ".get_element_type()"
                       << ", " << args[0].get_size() << ");\n;";
            }
