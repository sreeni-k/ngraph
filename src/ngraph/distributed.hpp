...
namespace ngraph
{
    ...
    public:
        ...
        virtual void
            all_reduce(void* in, void* out, const element::Type& element_type, size_t count) = 0;
        virtual void broadcast(void* in, const element::Type& element_type, size_t count) = 0;
    };
